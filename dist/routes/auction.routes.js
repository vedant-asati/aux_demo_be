...
// Public routes
router.post('/', auth_middleware_1.authMiddleware, auctionController.createNewAuction);
// Protected routes
...
router.put('/:id', auth_middleware_1.authMiddleware, owner_middleware_1.ownerMiddleware, auctionController.updateAuction);
router.delete('/:id', auth_middleware_1.authMiddleware, owner_middleware_1.ownerMiddleware, auctionController.deleteAuction);
